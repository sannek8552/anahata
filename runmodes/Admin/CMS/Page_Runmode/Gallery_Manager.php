...
class Gallery_Manager extends Runmode 
{
	...
	function process()
	{
		...
		{
			$gallery_holder = new Gallery_Holder($_REQUEST['id']);
	...
	function process_picture()
	{
		...
		return Admin_Header::out('CMS/Page_Runmode/gallery_manager_picture');
	}
}
?>
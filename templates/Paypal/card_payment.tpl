...
{/if}
<form method="post" action="{#script_url#}{seo_url rm="CardPayment"}">
...
<tr>
	...
	<td>
		<input type="text" name="cc_billing_zip" value="{if $cc_billing_zip}{$cc_billing_zip}{else}{$billing_info.postcode}{/if}"/>
...
<tr>
	<td>Address:</td>
	<td>
		<input type="text" name="cc_billing_address" value="{if $cc_billing_address}{$cc_billing_address}{else}{$billing_info.address}{/if}"/>

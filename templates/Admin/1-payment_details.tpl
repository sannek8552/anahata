...
<tr>
  ...
  <td align="left"><b>Address</b>: {$data.shipping_address}<br/>
		...
		<b>Phone</b>: {$data.shipping_phone}	</td>
  </tr>
<tr>
...
<tr>
  ...
  <td align="left">{$item_shippings[$data.shipping].method} {if $item_shippings[$data.shipping].price}{$item_shippings[$data.shipping].price|money}{else}free{/if}</td>
  </tr>
<tr>

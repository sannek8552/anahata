...
<script type="text/javascript" src="{#js_url#}Admin/CMS/page_creator_new.js?v=1"></script>

<div class="Menu">
<fieldset name="information" id="information">
      <legend>Страницы сайта</legend>
...
tinyMCE.init({
		...
		{/literal}content_css : "{#css_url#}main.css?1",{literal}

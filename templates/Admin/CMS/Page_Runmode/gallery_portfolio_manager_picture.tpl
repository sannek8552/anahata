...
<div class="NewButton"><a href="{#script_url#}{seo_url rm="Gallery_Portfolio_Manager"}">&larr; Back</a></div>
...
<table>
{*<tr><td colspan="2" align="center"><h1>Pictures for {$gallery_data.name}</h1></td></tr>*}
<tr>
	<td>Client name:</td>
...
<tr>
	...
	<td>{$item.order_no}</td>
	<td>
		<a title="Picture Edit" href="{#script_url#}{seo_url param1='picture' param2=$gallery_data.id param3='edit' param4=$item.id}"><img border="none" src="{#img_url#}picture_edit.png" alt="Picture Edit" /></a> 
		<a title="Picture Delete" href="{#script_url#}{seo_url param1='picture' param2=$gallery_data.id param3='delete' param4=$item.id}" onclick="return confirm('Are you sure?');"><img border="none" src="{#img_url#}picture_delete.png" alt="Picture Delete" /></a>
		{*<a href="#">Disable</a>*}
	</td>
</tr>
{/foreach}

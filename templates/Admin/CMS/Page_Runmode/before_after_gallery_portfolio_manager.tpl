...
<h2>Before &amp; After Gallery Manager</h2>
...
<tr>
	<td><strong>Width main Image:</strong></td>
	<td><input type="text" name="width1" value="{$width1}" title="integer___Enter integer"/></td>
</tr>
<tr>
	<td><strong>Width thumb Image:</strong></td>
	<td><input type="text" name="width2" value="{$width2}" title="integer___Enter integer"/></td>
</tr>
<tr>
	<td><strong>Color:</strong></td>
	<td><input type="text" name="color" value="{$color}" title="string___Enter Colour"/></td>
</tr>
<tr>
	<td>&nbsp;
...
<div class="NewButton"><a href="{#script_url#}{seo_url rm="Before_After_Gallery_Portfolio_Manager"}">Add New Gallery</a></div><br /><br />
...
<tr>
	<td>[before_after_gallery_portfolio_module?section={$item.id}]</td>
	<td>{$item.name}</td>
	...
	<a title="Pictures" href="{#script_url#}{seo_url param1='picture' param2=$item.id param3='clear'}"><img border="none" src="{#admin_img_url#}pictures.png" alt="Pictures" /></a>

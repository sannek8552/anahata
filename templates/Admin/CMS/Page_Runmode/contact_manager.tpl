...
<tr>
	<td><p>[contact_module?section={$item.id}]</p>
	  ...
	  <p>[contact_module?section={$item.id}&amp;protect=1]</p></td>
	...
	<td>
		<a title="{$L_EDIT}" href="{#script_url#}{seo_url param1="edit" param2=$item.id}" >
			<img border="0" src="{#admin_img_url#}edit.png" alt="{$L_EDIT}" />
		</a>
		<a title="{$L_FORM_FIELDS}" href="{#script_url#}{seo_url rm="Contact_Manager_Form" param1=$item.id}">
			<img border="0" src="{#admin_img_url#}detail.png" alt="{$L_FORM_FIELDS}"/>
		</a>
		<a title="{$L_DELETE}" href="{#script_url#}{seo_url param1="delete" param2=$item.id}" onclick="return confirm('{$L_ARE_YOU_SURE}');">
			<img border="none" src="{#admin_img_url#}cross.png" alt="{$L_DELETE}" />
		</a>

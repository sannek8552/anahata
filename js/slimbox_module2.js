...
var Lightbox = {
	...
	init: function(options){
		...
		this.fx = {
			...
			//resize: this.center.morph($extend({duration: this.options.resizeDuration, onComplete: nextEffect}, this.options.resizeTransition ? {transition: this.options.resizeTransition} : {})),
			resize: new Fx.Morph(this.center,{duration:this.options.resizeDuration,onComplete: nextEffect,transition: Fx.Transitions.Sine.easeOut}),
			//bottom: this.bottom.effect('margin-top', {duration: 400, onComplete: nextEffect})
			bottom: new Fx.Tween(this.bottom,{duration:400,onComplete:nextEffect})
		};
	},
	...
	open: function(inner_div){
		...
		this.fx.overlay.start('opacity',0.5);
	...
	close: function(){
		...
		this.fx.overlay.chain(this.setup.pass(false, this)).start('opacity',0);
		return false;
	},

...
var Lightbox = {
	...
	submit_form: function(form,runmode_name)
	{
	  ...
	  for(var i = 0; i < form.elements.length; i++)
	  {
	    ...
	    if (form.elements[i].tagName != 'FIELDSET' && form.elements[i].type != 'checkbox' && form.elements[i].type != 'radio' && form.elements[i].id != 'mce_editor_0')
	    ...
	    {
	      if (form.elements[i].id == 'mce_editor_0') params[form.elements[i].name] = tinyMCE.get('mce_editor_0').getContent();
